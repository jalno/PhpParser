...
use packages\PhpParser\Internal\DiffElem;
use packages\PhpParser\Internal\PrintableNewAnonClassNode;
use packages\PhpParser\Internal\TokenStream;
...
use packages\PhpParser\Node\Scalar;
use packages\PhpParser\Node\Stmt;
